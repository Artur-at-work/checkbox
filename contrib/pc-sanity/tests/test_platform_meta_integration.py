...
""",
        ...
        stdout, stderr, returncode = self.run_script(
            ["--oem-codename", "somerville"], mock_commands=mock_commands
        )
    ...
    def test_xenial_fails_without_matching_package(self):
        ...
        self.assertNotEqual(
            returncode, 0, "Script should fail without matching package"
        )
...
""",
        ...
        self.assertNotEqual(
            returncode, 0, "Script should fail when factory not installed"
        )
...
""",
        ...
        stdout, stderr, returncode = self.run_script(
            ["--oem-codename", "sutton.bachman"], mock_commands=mock_commands
        )
...
class TestStellaCmit(PlatformMetaIntegrationTest):
    ...
    def test_stella_not_supported(self):
        ...
        stdout, stderr, returncode = self.run_script(["--oem-codename", "stella"])
    ...
    def test_stella_cmit_not_supported(self):
        ...
        stdout, stderr, returncode = self.run_script(["--oem-codename", "stella.cmit"])
...
""",
        ...
        stdout, stderr, returncode = self.run_script(
            ["--oem-codename", "sutton"], mock_commands=mock_commands
        )
...
""",
        ...
        self.assertEqual(
            returncode, 0, f"'sutton.bachman' should work: {stdout}\n{stderr}"
        )
...
class TestArgumentParsing(PlatformMetaIntegrationTest):
    ...
    def test_invalid_oem_codename(self):
        ...
        stdout, stderr, returncode = self.run_script(["--oem-codename", "invalid-oem"])
