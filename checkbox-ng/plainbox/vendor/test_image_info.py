...
class TestDCDStringToInfoIoT(TestCase):
    ...
    def test_valid_dcd_no_additional_info(self):
        example = "canonical-oem-shiner:x8high-som-pdk:20241209-10:"
        info = image_info.dcd_string_to_info_iot(example)

        self.assertEqual(info["project"], "shiner")
        self.assertEqual(info["series"], "x8high-som-pdk")
        self.assertEqual(info["build_id"], "20241209-10")
        self.assertEqual(
            info["url"],
            "https://oem-share.canonical.com/partners/shiner/share/x8high-som-pdk/20241209-10/shiner-x8high-som-pdk-20241209-10.tar.xz"
        )
    ...
    def test_invalid_dcd_formats(self):
        ...
        for example in invalid_examples:
            with self.assertRaises(ValueError, msg=f"Should fail for: {example}"):
...
class TestDCDStringE2EIoT(TestCase):
    ...
    def test_dcd_info_iot_path_all_fields(self, mock_read_text, mock_is_file):
        ...
        mock_read_text.return_value = "canonical-oem-carlsbad:element-v2-uc24:20241205.15:v2-uc24-x01"
    ...
    @patch("pathlib.Path.is_file")
    @patch("pathlib.Path.read_text")
    def test_dcd_info_iot_path_no_additional_info(self, mock_read_text, mock_is_file):
        mock_is_file.return_value = True
        mock_read_text.return_value = "canonical-oem-shiner:x8high-som-pdk:20241209-10:"
    ...
    def test_dcd_info_iot_path_not_exists(self, mock_check_output, mock_is_file):
        ...
        self.assertEqual(
            info["url"],
            "https://oem-share.canonical.com/partners/pinktiger/share/releases/noble/24.04a/20240823-74/"
        )